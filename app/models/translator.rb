...
class Translator < ApplicationRecord
  ...
  def self.hello(info)
    if info[:lang_first] == 'espanol'
      ...
      info[:inphrase].include? "ñ"
      info[:inphrase].gsub!(/ñ/, "н")
      info[:inphrase].include? "ch"
      info[:inphrase].gsub!(/ch/, 'ч')
      info[:inphrase].include? "ll"
      info[:inphrase].gsub!(/ll/, 'ж')
      info[:inphrase].include? "rr"
      info[:inphrase].gsub!(/rr/, 'р')
      info[:inphrase].include? "qu"
      info[:inphrase].gsub!(/qu/, 'к')
      info[:inphrase].include? "a"
      info[:inphrase].gsub!(/a/, 'a')
      info[:inphrase].include? "b"
      info[:inphrase].gsub!(/b/, "б")
      info[:inphrase].include? "ce"
      info[:inphrase].gsub!(/ce/, "се")
      info[:inphrase].include? "ci"
      info[:inphrase].gsub!(/ci/, "си")
      info[:inphrase].include? "c"
      info[:inphrase].gsub!(/c/, "к")
      info[:inphrase].include? "d"
      info[:inphrase].gsub!(/d/, "д")
      info[:inphrase].include? "e"
      info[:inphrase].gsub!(/e/, "е")
      info[:inphrase].include? "f"
      info[:inphrase].gsub!(/f/, "ф")
      info[:inphrase].include? "ge"
      info[:inphrase].gsub!(/ge/, "хе")
      info[:inphrase].include? "gi"
      info[:inphrase].gsub!(/gi/, "хы")
      info[:inphrase].include? "gu"
      info[:inphrase].gsub!(/gu/, "г")
