module.exports = {
  topic: ['javascript', 'ruby', 'adobe', 'git', 'server', 'sql', 'tridimax', 'zbrush', 'literatura', 'otros'],
  javascript: ['vanella', 'es6', 'react', 'redux', 'json'],
  ruby: ['ruby', 'rails'],
  adobe: ['photoshop', 'illustrator', 'indesign', 'afterfx'],
  git: ['git', 'github'],
  server: ['digital_ocean', 'nginx', 'passenger', 'postgresql', 'cloudinary'],
  sql: ['postgresql', 'sql'],
