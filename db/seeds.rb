...
images.uniq.each do |image_address|
  picture = Carrusel.new(
              ...
              role: ['products', 'spaces', 'others', 'fotosJoyas', 'fotosComp', 'fotosCuadros', 'fotosDetalles', 'fotosPaisajes', 'fotosUrbano', 'fotosTexturas', 'fotosMuelles', 'fotosCuadrados'].sample,
              )
  unless picture.save
